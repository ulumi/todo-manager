...
export function renderAdminICal() {
  ...
  gcalDiv.innerHTML = connected
    ...
    : `<p style="font-size:13px;color:var(--text-muted);margin-bottom:8px;">Synchronise tes tâches en temps réel avec Google Calendar (bidirectionnel).</p>
       <button class="btn btn-primary" onclick="window.app.connectGoogleCalendar()" style="width:100%;">
       ...
       <button class="btn btn-ghost" onclick="window.app.cleanGcalTodos()" style="width:100%;font-size:12px;margin-top:8px;" title="Supprime les tâches importées depuis Google Calendar">🗑 Nettoyer les événements importés</button>`;
}
