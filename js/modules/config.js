...
export const TRANSLATIONS = {
  en: {
    ...
    frequentlyUsed:'Frequently used', quickAccess:'Quick access', recentlyAdded:'Recent', recurringTasks:'Recurring tasks', recurringDaily:'Daily tasks', recurringWeekly:'Weekly tasks', recurringMonthly:'Monthly tasks', templates:'Templates', suggestedRecurring:'Suggested recurring',
    quickInsertPlaceholder:'New task… (Enter to add, Esc to cancel)',
    emptyDay:'No tasks.', emptyDayAction:'Add a task', done:'done', noTasks:'No tasks',
    emptyRecurring:'No recurring tasks.', emptyPunctual:'No one-time tasks.',
    ...
    deleteRecurringTitle:'Delete recurring task', deleteRecurringPrompt:'How would you like to delete',
  ...
  fr: {
    ...
    frequentlyUsed:'Fréquemment utilisé', quickAccess:'Accès rapide', recentlyAdded:'Récent', recurringTasks:'Tâches récurrentes', recurringDaily:'Tâches quotidiennes', recurringWeekly:'Tâches hebdomadaires', recurringMonthly:'Tâches mensuelles', templates:'Modèles', suggestedRecurring:'Tâches suggérées',
    quickInsertPlaceholder:'Nouvelle tâche… (Entrée pour ajouter, Échap pour annuler)',
    emptyDay:'Aucune tâche.', emptyDayAction:'Ajouter une tâche', done:'fait', noTasks:'Aucune tâche',
    emptyRecurring:'Aucune tâche récurrente.', emptyPunctual:'Aucune tâche ponctuelle.',
    ...
    deleteRecurringTitle:'Supprimer une tâche récurrente', deleteRecurringPrompt:'Comment souhaitez-vous supprimer',
  ...
  es: {
    ...
    frequentlyUsed:'Usadas frecuentemente', quickAccess:'Acceso rápido', recentlyAdded:'Reciente', recurringTasks:'Tareas recurrentes', recurringDaily:'Tareas diarias', recurringWeekly:'Tareas semanales', recurringMonthly:'Tareas mensuales', templates:'Plantillas', suggestedRecurring:'Tareas sugeridas',
    quickInsertPlaceholder:'Nueva tarea… (Enter para añadir, Esc para cancelar)',
  ...
  de: {
    ...
    frequentlyUsed:'Häufig verwendet', quickAccess:'Schnellzugriff', recentlyAdded:'Kürzlich', recurringTasks:'Wiederkehrende Aufgaben', recurringDaily:'Tägliche Aufgaben', recurringWeekly:'Wöchentliche Aufgaben', recurringMonthly:'Monatliche Aufgaben', templates:'Vorlagen', suggestedRecurring:'Vorgeschlagene Aufgaben',
    quickInsertPlaceholder:'Neue Aufgabe… (Enter zum Hinzufügen, Esc zum Abbrechen)',
